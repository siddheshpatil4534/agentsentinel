...
crash -- the Audit Agent falls back to a local JSON file in that case.
"""
...
def get_supabase_client():
    ...
    try:
        ...
        # Missing package, bad creds, network down at startup, etc.
        # Audit Agent will fall back to the local JSON log.
        _client = None
